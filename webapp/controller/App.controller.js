sap.ui.define([
	...
	return Controller.extend("com.test.northwind.controller.App", {
		/**
		...
		synFinished: function() {
			...
			if (errorNum > 0) {
				if (!this._errDlg) {
					this._errDlg = sap.ui.xmlfragment("errorArchiveDialog", "com.test.northwind.view.ErrorArchive", this);
